...
- [x]  item 2. [후추] 생성자에 매개변수가 많다면 빌더를 고려하라
- [ ]  item 3. private 생성자나 열거 타입으로 싱글턴임을 보증하라
- [ ]  item 4. 인스턴스화를 막으려거든 private 생성자를 사용하라
- [x]  item 5. [루카] 자원을 직접 명시하지 말고 의존 객체 주입을 사용하라
...
- [x]  item 31. [말랑] 한정적 와일드카드를 사용해 API 유연성을 높이라
- [x]  item 32. [헤나] 제네릭과 가변인수를 함께 쓸 때는 신중하라
